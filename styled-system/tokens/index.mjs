const tokens = {
  ...
  "colors.line": {
    "value": "#C9DAE8",
    "variable": "var(--colors-line)"
  },
  "colors.shu": {
    "value": "#C2402F",
    "variable": "var(--colors-shu)"
  },
  "colors.shuSoft": {
    "value": "#F6E3E0",
    "variable": "var(--colors-shu-soft)"
  },
  "colors.edge": {
    "value": "#B7C1CA",
    "variable": "var(--colors-edge)"
  },
  "fonts.sans": {
  ...
  "fonts.body": {
    "value": "\"Hiragino Sans\", \"Hiragino Kaku Gothic ProN\", \"Noto Sans JP\", system-ui, sans-serif",
